...
public class Main {
    ...
    public static void main(String[] args) {
        //Ask the user how many passwords the wamt to generate
        Scanner scanner = new Scanner(System.in);
        System.out.println("How many random passwords do you want to generate? ");
        int total = scanner.nextInt();

        //Ask the user how long they want their passwords to be
        ...
        //randomly genarate passwords total number of times
    ...
    public static char randomCharacter(){
        ...
        if(rand <= 9){
            ...
            //To convert from 0-9 to 48-57, we can add 48 to rand because 48-o = 48
            ...
            int lowecase = rand + 61;
            return (char)(lowecase);
